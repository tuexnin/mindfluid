...
<section class="hero-area">
    <div class="hero-slides owl-carousel">
        ...
        <!-- Single Hero Slide -->
        <div class="single-hero-slide bg-img" style="background-image: url(img/bg-img/repu.jpg);">
        ...
        <!-- Single Hero Slide -->
        <div class="single-hero-slide bg-img" style="background-image: url(img/bg-img/lol.png);">
            <div class="container h-100">
                <div class="row h-100 align-items-center">
                    <div class="col-12">
                        <div class="hero-slides-content ml-50">
            ...
            <div class="col-12 col-sm-6 col-lg-4">
                <div class="single-course-area d-flex align-items-center mb-100 wow fadeInUp" data-wow-delay="300ms">
                    ...
                    <div class="course-content">
                        <h4>Bombas</h4>
                        <p>los mejores del mercado en el peru.</p>
                    </div>
                </div>
            </div>
            <!-- Single Course Area -->
        ...
        <div class="row">
            <div class="col-12">
                <div class="section-heading text-center mx-auto white wow fadeInUp" data-wow-delay="300ms">
                    <span>Diagrama de Productos</span>
                    <h3>Mira que tan satisfechos estan nuestros clientes con nostros</h3>
                </div>
            </div>
        </div>
        <div class="">
            ...
            <div class="col-12 col-lg-6">
                <div class="single-top-popular-course d-flex align-items-center flex-wrap mb-30 wow fadeInUp" data-wow-delay="400ms">
                    <div class="popular-course-content">
                        ...
                        <span><?php echo $fila['fecpublicacion']; ?></span>
                        ...
                        <a href="productos.php?id=<?php echo $fila['idproducto']; ?>" class="btn academy-btn btn-sm">Mas informacion</a>
                    </div>
                    <div class="popular-course-thumb bg-img" >
                        <img class="imgpro1" src="../admin/files/productos/<?php echo $fila['foto']; ?>" alt="alt"/>
                    </div>
                </div>
            </div>
