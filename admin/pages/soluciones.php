<!-- Page Heading -->
<h1 class="h3 mb-2 text-gray-800">Soluciones</h1>
<p class="mb-4">Listado de Soluciones.</p>
...
<div class="panel-body" id="formularioregistros">
    <form name="formulario" id="formulario" method="POST">
        <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
            ...
            <input type="hidden" name="tipopublicacion" id="tipopublicacion" value="soluciones">
...
<script src="scripts/soluciones.js"></script>